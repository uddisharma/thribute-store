  ...
  },
  {
    ...
    render: (_: string, row: any) => (
      <div className="flex items-center justify-end gap-3 pe-4">
        ...
        <RecyclePopover
          title={`Recycle this Ticket`}
          description={`Are you sure you want to recycle this ticket? `}
          onDelete={() => onTemperoryDelete(row.id)}
        />
        <Tooltip
          size="sm"
          content={() => 'Permanently Delete this Ticket'}
          placement="top"
          color="invert"
        >
          <DeletePopover
