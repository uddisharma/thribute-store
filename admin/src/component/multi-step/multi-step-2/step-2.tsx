...
import FormPart from '@/component/multi-step/form-part';
import BasicInfo, {
  BasicInfoSchema,
  basicInfoValues,
} from '@/component/multi-step/basic-info';
import UploadPhoto from '@/component/multi-step/upload-photo';
import AccommodationInfo, {
  AccommodationSchema,
  accommodationValues,
} from '@/component/multi-step/accommodation-info';
import { useStepperOne } from '@/component/multi-step/multi-step-1';
