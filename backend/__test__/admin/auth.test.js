...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Ludwig_Bayer56',
      password: 'n18u4uIcKATe6w4',
      email: 'Althea.Rath@yahoo.com',
      name: 'Mrs. Lamar Wolf',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 190,
      mobileNo: '(326) 567-4793',
      resetPasswordLink: {},
      loginRetryLimit: 198,
      loginReactiveTime: '2024-08-30T05:34:24.668Z',
      id: '653a7736750a1beb9198f874'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Belle_Pfannerstill13',
        'password':'VzEBe1QRWACCxRD',
        'email':'Shaina.Murray41@hotmail.com',
        'name':'Isabel Feil',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Bike',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Shaina.Murray41@hotmail.com', });
