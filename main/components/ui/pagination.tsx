...
const classes = {
  base: {
    item: "[&>.rc-pagination-item>a]:text-black [&>.rc-pagination-item>a]:font-medium [&>li.rc-pagination-item]:border-gray-300 [&>.rc-pagination-item>a]:hover:text-black [&>.rc-pagination-item>a]:focus:text-black [&>.rc-pagination-item:not(.rc-pagination-item-active)]:bg-transparent",
    ...
    jumperDiv:
      "[&>.rc-pagination-options>.rc-pagination-options-quick-jumper]:text-sm [&>.rc-pagination-options>.rc-pagination-options-quick-jumper]:text-black",
    jumperInput:
  ...
  variant: {
    ...
    flat: {
      ...
      color: {
        DEFAULT:
          "[&>.rc-pagination-item-active]:bg-linear [&>li.rc-pagination-item-active]:border-black [&>.rc-pagination-item-active>a]:!text-black [&>.rc-pagination-item-active>a]:hover:!text-black [&>.rc-pagination-item-active>a]:focus:!text-black [&>.rc-pagination-item-active]:hover:border-black [&>.rc-pagination-item-active]:focus:border-black",
        primary:
