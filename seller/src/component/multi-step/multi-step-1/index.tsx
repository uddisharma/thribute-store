...
import StepOne from '@/component/multi-step/multi-step-1/step-1';
import StepTwo from '@/component/multi-step/multi-step-1/step-2';
import StepThree from '@/component/multi-step/multi-step-1/step-3';
import StepFour from '@/component/multi-step/multi-step-1/step-4';
import StepFive from '@/component/multi-step/multi-step-1/step-5';
import StepSix from '@/component/multi-step/multi-step-1/step-6';
import StepSeven from '@/component/multi-step/multi-step-1/step-7';
import Congratulations from '@/component/multi-step/multi-step-1/congratulations';
