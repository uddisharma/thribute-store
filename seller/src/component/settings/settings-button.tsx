...
import CogSolidIcon from '@/component/icons/cog-solid';
import { ActionIcon } from '@/component/ui/action-icon';
import DrawerHeader from '@/component/settings/drawer-header';
import { usePresets } from '@/config/color-presets';
import { useApplyColorPreset, useColorPresets } from '@/hooks/use-theme-color';
import { useDrawer } from '@/component/drawer-views/use-drawer';
const SettingsDrawer = dynamic(
  () => import('@/component/settings/settings-drawer'),
  {
    ssr: false,
  }
);
